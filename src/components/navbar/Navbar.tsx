      ...
      <div className='flex pl-10 justify-end items-center gap-6 self-stretch'>
        <div className='flex justify-center items-center gap-5 sm:gap-8 lg:gap-[2.8125rem]'>
          ...
          <div className='text-end'>
            <p className='text-xs font-poppins font-medium'>Johnathan</p>
            <p className='text-xs text-inputBorder font-poppins font-normal'>PM,Tecessc LLC</p>
          </div>
          <img className='w-7' src={profilePic}/>
