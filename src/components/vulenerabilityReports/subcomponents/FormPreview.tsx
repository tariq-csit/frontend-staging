...
function formPreview(props: { data: data | undefined; setPreview: (value: boolean) => void }) {
  return (
    <div className="flex flex-col sm:flex-row gap-8 font-poppins mx-6">
      <div className="sm:w-9/12 flex flex-col gap-6 p-6 bg-white rounded-lg">
        <div className="flex flex-col gap-2">
          <h2 className="text-2xl font-medium">Submit vulnerability report</h2>
          <p>
            Provide detailed information to ensure easy validation and review.
            Include affected hosts, severity, CVSS metrics, steps to reproduce,
            and relevant attachments for a thorough report. All fields are
            mandatory unless marked as optional.{" "}
          </p>
        </div>
        ...
        <div className="flex flex-col gap-2">
          ...
          <div
            className="text-previewText"
            dangerouslySetInnerHTML={{ __html: props.data?.stepToReproduce || "" }}
          ></div>
        </div>
        ...
        <div className="grid grid-cols-2">
          ...
          <div className="flex flex-col gap-6">
            <div className="flex flex-col gap-2">
              ...
              <p className="text-previewText">{props.data?.attackComplexity}</p>
            </div>
            <div className="flex flex-col gap-2">
            ...
            <div className="flex flex-col gap-2">
              ...
              <p className="text-previewText">{props.data?.confidentiality}</p>
            </div>
            <div className="flex flex-col gap-2">
        ...
        <div className="flex flex-col gap-6">
          <div className="flex flex-col gap-4">
            ...
            <p className="text-[#3A3B3D]">
              ...
              against your computer system to check for vulnerabilities that an
              attacker could exploit. It involves assessing the security of the
              system by attempting to breach various application systems,
              including APIs, frontend/backend servers, and network services.
              The goal is to identify weaknesses before they can be exploited by
              malicious actors.
            </p>
          </div>
          <div>
          ...
          <div className="flex gap-4">
            <Button variant={"outline"} onClick={() => props.setPreview(false)}>
              Go Back
            </Button>
